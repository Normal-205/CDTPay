<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  ...
  <head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/style/css/home_user_style.css" />
    <link rel="stylesheet" href="${pageContext.request.contextPath}/style/font/fontawesome-free-6.3.0-web/css/all.min.css" />
  </head>
  ...
  var myChart1 = new Chart(ctx1, {
    ...
    $(document).ready(function () {
      $("#header").load("./admin/admin_layout.jsp", function () {
        $("#header")
          .find(".navbar_item")
          .eq(0)
